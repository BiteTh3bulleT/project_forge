...
- `docs/reviews/archive/phase_13/phase_13i_store_cutover_readiness_review.md`
- `docs/reviews/phase_14b_ref_shape_validation_review.md`
- `docs/reviews/phase_14c_control_lane_validation_expansion_review.md`
- `docs/reviews/phase_14d_control_lane_validation_shadow_reporting.md`
- `docs/reviews/archive/phase_12/phase_12f_route_envelope_shadow_hardening.md`
- `docs/reviews/archive/phase_12/phase_12g_chat_metadata_risk_review.md`
- `docs/reviews/archive/phase_12/phase_12kl_retrieval_metadata_shadow_hardening.md`
- `docs/reviews/archive/phase_12/phase_12mq_shadow_advisory_pipeline.md`
...
The Phase G4/G5/G6 graphical shell session is still opt-in. It may expose a selectable Wayland session, imported VM test profile, or read-only operator status surfaces, but it must not autostart, enable autologin, remove normal desktop or TTY fallback, run host commands, restart services, mutate NixOS configuration from wrappers, call modelruntime mutation paths, write memory, expose mutation controls, or route live authority through FORGE-K.
...
- `docs/operations/virtualbox_forge_shell_test.md`
...
Phase G5 VirtualBox graphics testing uses the same shell path from a minimal NixOS TTY:
