...
Status marker: `DESKTOP_SHELL_POLISH / OPERATOR_UI_AUTHORITY / LABWC_SUBSTRATE_PRESERVED / POLICY_GATED_HOST_POWER_DISABLED_BY_DEFAULT / NO_FORGE_K_AUTHORITY_EXPANSION`
