...
- Phase 14B remains future implementation and must select one deterministic validation contract, add tests, and preserve rollback before any live behavior change.
