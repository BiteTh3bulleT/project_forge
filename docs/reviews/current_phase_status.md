...
- Phase 12K-L preflight passed before edits: `cd services/core && go test ./internal/forgek/...`, `cd services/core && go test ./internal/forgekshadow/...`, `cd services/core && go test ./internal/api -run "TestServerRouteInventory|TestServerRouteInventoryHealthAndMiddlewareSmoke" -count=1`, and `cd services/core && go test ./internal/api -count=1`.
