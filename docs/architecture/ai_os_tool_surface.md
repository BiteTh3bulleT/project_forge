...
| `model.delete_file` | approval_required alias / real via runtime API | deletes only managed active/archive model directories under `FORGE_MODEL_HOME` after high-risk approval |
