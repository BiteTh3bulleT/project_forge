...
func forgeKAuthorityGateMatrixReadiness(validationReady bool) []ForgeKAuthorityGateMatrixEntry {
	...
	return []ForgeKAuthorityGateMatrixEntry{
		...
		},
		{
			...
			RollbackPath:    "offline verified store/generation rollback; retain immutable Court history",
		...
		},
		{
			...
			RollbackPath:  "offline verified store/generation rollback; retain immutable rows as historical evidence",
