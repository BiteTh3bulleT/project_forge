...
func (s *Service) EnsureDefaults(ctx context.Context, workspaceDir string) error {
	...
	defaultProfile := Profile{
		...
		AllowedTools:         []string{"fs.read", "fs.list", "fs.mkdir", "repo.inspect", "git.status", "git.diff", "git.branch", "validate.project_context", "net.interfaces", "net.dns_lookup", "net.connectivity"},
	...
	hardenedProfile := Profile{
		...
		AllowedTools:         []string{"fs.read", "fs.list", "repo.inspect", "git.status", "git.diff", "git.branch", "validate.project_context", "net.interfaces"},
