...
var extractQueries = map[string]string{
	...
	"court_exhibits":                "SELECT * FROM court_exhibits ORDER BY created_at ASC, id ASC",
	"court_rulings":                 "SELECT * FROM court_rulings ORDER BY created_at ASC, id ASC",
	"court_appeals":                 "SELECT * FROM court_appeals ORDER BY created_at ASC, id ASC",
	"forge_k_journal_head":          "SELECT * FROM forge_k_journal_head ORDER BY id ASC",
	"forge_k_audit_outbox":          "SELECT * FROM forge_k_audit_outbox ORDER BY created_at ASC, id ASC",
