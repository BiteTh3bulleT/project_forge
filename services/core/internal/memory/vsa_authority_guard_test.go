...
func TestLegacyMemoryPackageCannotWriteVSAProjection(t *testing.T) {
	...
	forbidden := []string{
		...
		"delete from memory_repair_runs",
		...
		"insert into forge_k_memory_vsa_",
		"update forge_k_memory_vsa_",
		"delete from forge_k_memory_vsa_",
		"insert into forge_k_memory_evidence",
		"update forge_k_memory_evidence",
		"delete from forge_k_memory_evidence",
